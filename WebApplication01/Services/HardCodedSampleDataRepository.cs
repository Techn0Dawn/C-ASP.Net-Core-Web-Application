    ...
    public class HardCodedSampleDataRepository : IProductDataService
    {
        ...
        public List<ProductModel> GetAllProducts()
        {
            if (productsList.Count == 0)
            {
                ...
                productsList.Add(new ProductModel { Id = 2, Name = "Webcam", Price = 45.50m, Description = "Enables you to attend more Zoom meetings." });
                productsList.Add(new ProductModel { Id = 3, Name = "4 TB USB hard drive", Price = 130.00m, Description = "Backup all of your work. You wont regret it." });
                ...
                for (int i = 0; i < 100; i++)
                {
                    //Bogus library to create Fake Data
